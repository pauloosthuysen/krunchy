...
<div id="show-note" class="content scaffold-show" role="main">
    ...
    <ol class="property-list note">
        ...
        <g:if test="${noteInstance?.name}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${noteInstance}"
                                                                                        field="name"/></span>

            </li>
        </g:if>

        <g:if test="${noteInstance?.subject}">
            <li class="fieldcontain">
                <span id="subject-label" class="property-label"><g:message code="note.subject.label"
                                                                           default="Subject"/></span>

                <span class="property-value" aria-labelledby="subject-label"><g:fieldValue bean="${noteInstance}"
                                                                                           field="subject"/></span>
    ...
    <g:form>
        <fieldset class="buttons">
            ...
            <g:link class="edit" action="edit" id="${noteInstance?.id}"><g:message code="default.button.edit.label"
                                                                                   default="Edit"/></g:link>
